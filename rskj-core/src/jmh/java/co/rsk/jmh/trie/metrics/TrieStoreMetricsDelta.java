...
public final class TrieStoreMetricsDelta {
    ...
    public static TrieStoreMetricsDelta from(TrieStoreMetricsSnapshot older, TrieStoreMetricsSnapshot newer) {
        return new TrieStoreMetricsDelta(
                newer.getGetOps() - older.getGetOps(),
                newer.getPutOps() - older.getPutOps(),
                newer.getDeleteOps() - older.getDeleteOps(),
                newer.getUpdateBatchOps() - older.getUpdateBatchOps(),
                newer.getFlushOps() - older.getFlushOps(),
                newer.getBytesRead() - older.getBytesRead(),
                newer.getBytesWrittenKeys() - older.getBytesWrittenKeys(),
                newer.getBytesWrittenValues() - older.getBytesWrittenValues()
        );
    }
